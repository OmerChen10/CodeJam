...
class StorageManager():
    ...
    def get_files(self, project_id):
        ...
        path = os.path.join(StorageConfig.PROJECTS_PATH,
                            str(project_id), "src")
    ...
    def edit_file_name(self, project_id, old_name, new_name):
        ...
        old_path = os.path.join(
            StorageConfig.PROJECTS_PATH, str(project_id), "src", old_name)
        new_path = os.path.join(
            StorageConfig.PROJECTS_PATH, str(project_id), "src", new_name)
