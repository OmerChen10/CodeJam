...
class ContainerController:
    def __init__(self, project: Project, web_clients):
        ...
        self.sql_controller = SQLController.get_instance()
    ...
    def get_container(self):
        ...
        past_container = self.sql_controller.get_container_id(self.project.id)
        if past_container is None:
            container = self.create_container()
            self.sql_controller.set_container_id(self.project.id, container.id)
            return container
