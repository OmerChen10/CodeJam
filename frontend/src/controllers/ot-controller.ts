...
export class SharedbController {
    private static instance: SharedbController;
    ...
    public static getInstance() {
        if (!SharedbController.instance) {
            SharedbController.instance = new SharedbController();
        }
        return SharedbController.instance;
    }
